        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              De Travel Task (PVT) Ltd was established to elevate northern tourism in Pakistan from crowded trips to refined, executive-class experiences. We believe travel should be soul-stirring, seamless, and steeped in genuine hospitality.
            </p>
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
