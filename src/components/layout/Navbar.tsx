        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3 group shrink-0">
            ...
            <div className="flex flex-col">
              <span className={`font-brand font-bold text-xl sm:text-2xl tracking-tight leading-none ${
                isSolid ? "text-slate-900" : "text-white"
              }`}>
                De Travel <span className={isSolid ? "text-brand-primary" : "text-brand-accent"}>Task</span>
              </span>
            ...
            <div className="flex items-center justify-between pb-5 border-b border-slate-800">
              <Link href="/" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2.5">
                <div className="relative w-10 h-10 rounded-full overflow-hidden bg-slate-900 border border-slate-700/50 shrink-0">
                  <Image src="/images/logo.png" alt="De Travel Task" fill className="object-cover" />
                </div>
                <div className="flex flex-col">
                  <span className="font-brand font-bold text-xl tracking-tight text-white">
                    De Travel <span className="text-brand-accent">Task</span>
                  </span>
